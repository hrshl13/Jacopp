...
public class myProfilePrincipal extends JFrame {
	...
	public myProfilePrincipal() {
		...
		JLabel lblNewLabel_2 = new JLabel("user0001");
		...
		JLabel lblNewLabel_6 = new JLabel("19/08/1970");
