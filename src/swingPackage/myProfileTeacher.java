...
public class myProfileTeacher extends JFrame {
	...
	public myProfileTeacher() {
		...
		JLabel lblNewLabel_2 = new JLabel("user8719");
		...
		JLabel lblNewLabel_4 = new JLabel("Teacher1");
		...
		JLabel lblNewLabel_6 = new JLabel("24/09/1977");
